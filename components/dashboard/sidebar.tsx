  ...
  return (
    <aside className="bg-[#fcfaf8] border-r border-[#f4ede7] w-full md:w-64 min-h-screen flex flex-row md:flex-col md:fixed md:top-0 md:left-0 z-20">
      <nav className="flex flex-1 flex-row md:flex-col gap-2 md:gap-4 p-2 md:p-6 w-full">
        ...
        <Link href="/dashboard/analytics" className="w-full px-4 py-2 rounded-lg text-[#1c140d] font-semibold hover:bg-[#f4ede7] transition">Analytics</Link>
        <Link href="/dashboard/users" className="w-full px-4 py-2 rounded-lg text-[#1c140d] font-semibold hover:bg-[#f4ede7] transition">Users</Link>
